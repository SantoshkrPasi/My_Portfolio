        ...
        <div className='bg-cyan-900 min-h-screen flex items-center justify-center'>
            <div className='  h-5/6 w-5/6 justify-center items-center flex gap-10 flex-col-reverse lg:flex-row'>
                <div className=' h-3/4 w-4/5 m-10 flex-col justify-center items-center'>
                    <h3 className='font-sans text-xl'>Hello, I am</h3>
                    <h1 className='font-mono text-2xl'>Santosh Kumar Pasi </h1>
                    <h1 className='font-mono text-2xl'>I'm a Full Stack</h1>
                    <h1 className='font-mono text-2xl'>Developer</h1>
                    <p className='font-serif text-lg'><Typewriter text="Building Bridges Between Front-End and Back-End, Transforming Ideas into Web Reality" delay={50} /></p>
